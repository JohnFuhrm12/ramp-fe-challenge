...
# Bug 1: Select dropdown doesn't scroll with rest of the page *DONE* - **CSS Change, InputSelect Container - Pos: Absolute**
...
# Bug 2: Approve checkbox not working *DONE* - **CSS Change, Display: None --> Opacity 0 and Margin Offset**
...
# Bug 3: Cannot select _All Employees_ after selecting an employee *DONE* - **In App.tsc, if no id, set to Empty, then load all, remove thow error in rquests.ts**
...
# Bug 4: Clicking on View More button not showing correct data  *DONE, index.tsx, app.tsx, usepaginated, get previous results and append them to current results**
...
# Bug 7: Approving a transaction won't persist the new value DONE - Updated transaction.approved in TransactionPane.tsx
